...
export const projects = [
  {
    ...
    name: "Quill",
    description:
      "Complete AI SaaS Platform with Next.js 13, React, Prisma, tRPC, Tailwind CSS enabling users to upload a PDF document and chat with AI assistant about the document with free tier and paid subscriptions.",
  ...
  },
  {
    ...
    name: "Scuttle",
    description:
      "Marketplace of high-quality digital assets across various categories, with features like admin verification for quality products. It also has file uploading, CMS integration, and role based authentication (Buyer and Seller).",
    link: "https://github.com/PrathmeshSadake/scuttle",
  },
  // {
  //   iconUrl: car,
  //   theme: "btn-back-blue",
